...
- Branding lives in `custom_components/yunoheat/brand/` (HACS requires this exact dir name); `icon.svg`/`logo.svg` are the editable sources — regenerate the 512×512 PNGs with cairosvg rather than editing PNGs directly.
